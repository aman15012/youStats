...
## About
This webapp requests data about videos on a topic from Youtube API and generates cool visualizations with the data. The data collected has been set to 500 videos.
